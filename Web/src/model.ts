...
export const FALLBACK_ITEM_TYPES: readonly PaletteItemPresentation[] = [
  ...
  { type: "microphone", label: "Microphone", icon: "🎙", description: "Affiche et bascule l’état du microphone d’entrée par événements Core Audio natifs, sans interrogation périodique.", examples: ["Micro actif", "Micro coupé"] },
